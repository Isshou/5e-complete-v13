...
## Installation
For copyright reasons, 5e Complete will not be published on official platforms. Please install using the `5e-complete-v13.zip` or the following manifest:

```https://github.com/isshou/5e-complete-v13/releases/latest/download/module.json```
